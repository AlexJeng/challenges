...
describe DateRangeFormatter do
  ...
  it "formats date range for different year with starting time and ending times" do
  ...
  context "different date format" do
    it "formats date range for different year" do
      formatter = DateRangeFormatter.new "10th October 2009", "10th October 2010"
      formatter.to_s.should == "10th October 2009 - 10th October 2010"
    end
  end
end
